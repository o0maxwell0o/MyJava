...
public class No126_FindLadders {
    public static void main(String[] args) {
        ...
        System.out.println(findLadders("hit", "cog", testdata));
    }

    private static final int INF = 1 << 20;
    private static Map<String, Integer> wordId = new HashMap<>(); // 单词到id的映射
    private static ArrayList<String> idWord = new ArrayList<>(); // id到单词的映射
    private static ArrayList<Integer>[] edges; // 图的边
    ...
    static boolean transformCheck(String str1, String str2) {
        int differences = 0;
